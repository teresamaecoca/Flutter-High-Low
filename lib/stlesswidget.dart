      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
              'HIGH LOW CARD GAME By: Teresa Mae Coca',
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontFamily: 'ShadowsIntoLight-Regular',
                  fontSize: 25,
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
              ' This game is a game of chance. The players will guess if the next card to be overturned will be higher or lower than the previous. Just click HIGH if you think the card is high and click LOW if the card is low. And then, click NEXT to next the card. Please enjoy the game. ',
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontFamily: 'ShadowsIntoLight-Regular',
                  fontSize: 25,
